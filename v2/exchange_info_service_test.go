		...
		"symbols": [
			{
				...
				"quoteAsset": "BTC",
				"quotePrecision": 8,
				"orderTypes":["LIMIT","LIMIT_MAKER","MARKET","STOP_LOSS_LIMIT","STOP"],
				"icebergAllowed": true,
				"ocoAllowed": true,
		...
		Symbols: []Symbol{
			{
				...
				QuoteAsset:             "BTC",
				QuotePrecision:         8,
				OrderTypes:             []string{"LIMIT", "LIMIT_MAKER", "MARKET", "STOP_LOSS_LIMIT", "STOP"},
				IcebergAllowed:         true,
				OcoAllowed:             true,
				IsSpotTradingAllowed:   true,
				IsMarginTradingAllowed: false,
		...
		"symbols":[
			{
				...
				"orderTypes":["LIMIT","LIMIT_MAKER","MARKET","STOP_LOSS","STOP_LOSS_LIMIT","STOP_MARKET","STOP"],
				"icebergAllowed":true,
				"ocoAllowed":true,
				"otoAllowed":true,
